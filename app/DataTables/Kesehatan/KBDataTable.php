...
class KBDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('delete', function($request){    
            return view ('datatable._delete',[
                'model'    => $request,
                'delete_url' => route('KB.destroy', $request->id),
                'confirm_message' => 'Yakin ingin menghapus Data KB ' . $request->nama . '?'
            ]);                 
        })
    ...
    protected function getColumns()
    {
        return [
            ...
            (['data'=> 'jenis_kb' ,'name' => 'jenis_kb' , 'title' => 'Jenis KB']),
