...
class BumilDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('delete', function($request){    
            return view ('datatable._delete',[
                'model'    => $request,
                'delete_url' => route('bumil.destroy', $request->id),
                'confirm_message' => 'Yakin ingin menghapus Data Ibu Hamil ' . $request->nama . '?'
            ]);                 
        })
