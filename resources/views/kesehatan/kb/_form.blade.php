...
<div class="modal-body">
 <div class="row">
    ...
    <div class="col-sm-8">
        ...
        <div class="col-sm-8">
            <div class="form-group form-float{{ $errors->has('jenis_kb') ? 'has-error': '' }} ">
                {!! Form::label('jenis_kb', 'Jenis KB yang Digunakan', ['class'=>'form-label']) !!}
                    {!! Form::select('jenis_kb', ['Suntik' => 'Suntik', 'Implan' => 'Implan', 'IUD' => 'IUD',
                     'Pil' => 'Pil', 'Kondom' => 'Kondom', 'MOW' => 'MOW',
                     'MOP' => 'MOP'],null,[ 'class' => 'js-selectize', 'placeholder' => 'Pilih' ]) !!}
                {!! $errors->first('jenis_kb', '<p class="error">:message</p>') !!}
            </div>
        </div>
    </div>
